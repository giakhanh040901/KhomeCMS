...
{
    public class UpdateCpsInfoOverviewContentDto
    {
        ...
        /// </summary>
        public List<CreateCpsSecondaryOverviewFileDto> SecondaryOverviewFiles { get; set; }

        /// <summary>
        /// Thêm các tổ chức liên quan
        /// </summary>
        public List<CreateCpsSecondaryOverviewOrgDto> SecondaryOverviewOrgs { get; set; }
    }
}
