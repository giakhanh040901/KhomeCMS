...
{
    public class CreateGarnerPolicyTempDto
    {
        private string _code;
        [Required(ErrorMessage = "Mã chính sách mẫu không được để trống")]
        [StringLength(100, ErrorMessage = "Mã chính sách mẫu không được dài hơn 100 ký tự")]
        public string Code
        {
            get => _code;
        ...
        [Required(ErrorMessage = "Tên chính sách mẫu không được để trống")]
        [StringLength(256, ErrorMessage = "Tên chính sách mẫu không được dài hơn 256 ký tự")]
        public string Name
        {
            get => _name;
        ...
        public List<CreateGarnerPolicyDetailTempDto> PolicyDetails { get; set; }
        public List<CreateGarnerContractTemplateTempDto> ContractTemplateTemps { get; set; }
    }
}
