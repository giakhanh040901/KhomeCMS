...
{
    [Table("GAN_CONTRACT_TEMPLATE", Schema = DbSchemas.EPIC_GARNER)]
    [Comment("Mau hop dong")]
    public class GarnerContractTemplate : IFullAudited
    {
        public static string SEQ = $"SEQ_{nameof(GarnerContractTemplate).ToSnakeUpperCase()}";
        [Key]
