...
namespace EPIC.RealEstateEntities.DataEntities
{
    ...
    /// </summary>
    [Table("RST_DISTRIBUTION_POLICY_TEMP", Schema = DbSchemas.EPIC_REAL_ESTATE)]
    [Index(nameof(Deleted), nameof(PartnerId), nameof(Status), IsUnique = false, Name = "IX_RST_DISTRIBUTION_POLICY_TEMP")]
    public class RstDistributionPolicyTemp : IFullAudited
    {
        public static string SEQ { get; } = $"{DbConsts.SEQ}{nameof(RstDistributionPolicyTemp).ToSnakeUpperCase()}";
