...
namespace EPIC.RealEstateEntities.DataEntities
{
    ...
    /// </summary>
    [Table("RST_HISTORY_UPDATE", Schema = DbSchemas.EPIC_REAL_ESTATE)]
    [Index(nameof(RealTableId), nameof(UpdateTable), IsUnique = false, Name = "IX_RST_HISTORY_UPDATE")]
    public class RstHistoryUpdate : ICreatedBy
    {
        public static string SEQ { get; } = $"SEQ_{nameof(RstHistoryUpdate).ToSnakeUpperCase()}";
        ...
        /// <summary>
        /// Loại hình
        /// <see cref="RstHistoryTypes"/>
        /// </summary>
        [ColumnSnackCase(nameof(Type))]
        public int? Type { get; set; }

        public RstHistoryUpdate()
        { 
        }

        public RstHistoryUpdate(int realTableId, string oldValue, string newValue, string fieldName, int updateTable, int action, string summary, DateTime date)
        {
        ...
        public RstHistoryUpdate(int realTableId, string oldValue, string newValue, string fieldName, int updateTable, int action, string summary, DateTime date, int? type)
        {
            RealTableId = realTableId;
            OldValue = oldValue;
            NewValue = newValue;
