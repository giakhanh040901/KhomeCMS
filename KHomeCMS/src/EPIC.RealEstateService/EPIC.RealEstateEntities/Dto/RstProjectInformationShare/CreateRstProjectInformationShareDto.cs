...
{
    public class CreateRstProjectInformationShareDto
    {
        /// <summary>
        /// Id dự án
        /// </summary>
        ...
        /// </summary>
        public List<CreateRstProjectInfoShareDetailDto> DocumentFiles { get; set; }

        /// <summary>
        /// Danh sách file hình ảnh
        /// </summary>
        public List<CreateRstProjectInfoShareDetailDto> ImageFiles { get; set; }
    }
}
