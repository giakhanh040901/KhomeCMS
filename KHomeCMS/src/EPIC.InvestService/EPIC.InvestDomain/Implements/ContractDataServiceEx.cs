...
namespace EPIC.InvestDomain.Implements
{
    public partial class ContractDataServices : IContractDataServices
    {
        private void HopDongSoVaNgayLap(List<ReplaceTextDto> replateTexts, string contractCode, DateTime createdDate)
        {
            ...
            {
                new ReplaceTextDto("{{ContractCode}}", contractCode),
                new ReplaceTextDto("{{TranContent}}", contractCode),
                new ReplaceTextDto("{{DayContract}}", createdDate, "dd"),
                new ReplaceTextDto
                {
        ...
        private void ThongTinNhaDauTu(List<ReplaceTextDto> replateTexts, InvOrder order, bool isSignature)
        {
            ...
            else
            {
                ...
                replateTexts.AddRange(new List<ReplaceTextDto>()
                {
                    ...
                    new ReplaceTextDto
                    {
                         FindText = "{{CustomerResidentAddressA}}",
                         ReplaceText = businessCustomer.Address
                    },
                    new ReplaceTextDto
                    {
                    ...
                    {
                         FindText = "{{CustomerReferralCodeSelf}}",
                         ReplaceText = businessCustomer.ReferralCodeSelf
                    }
                });
            }
        ...
        private void ThongTinNhaDauTuCaNhan(List<ReplaceTextDto> replateTexts, int investorId, int identificationId, int bankAccId)
        {
            ...
            var investorContactAddress = _managerInvestorRepository.GetDefaultContactAddress(investorId, false);
            ...
            replateTexts.AddRange(new List<ReplaceTextDto>()
            {
                ...
                {
                    FindText = "{{CustomerIdExpiredDate}}",
                    ReplaceText = identification.IdExpiredDate?.ToString("dd/MM/yyyy")
                },
                new ReplaceTextDto
                {
                    FindText = "{{CustomerPhone}}",
                ...
                {
                    FindText = "{{CustomerNationality}}",
                    ReplaceText = identification.Nationality
                },
                new ReplaceTextDto
                {
                    FindText = "{{CustomerReferralCodeSelf}}",
                    ReplaceText = investor.ReferralCodeSelf
                }, 
                new ReplaceTextDto
                {
                    FindText = "{{CustomerContactAddress}}",
                    ReplaceText = investorContactAddress?.ContactAddress
                }
        ...
        /// <exception cref="FaultException"></exception>
        private void DuAn(List<ReplaceTextDto> replateTexts, Project project)
        {
            replateTexts.Add(new ReplaceTextDto
            {
                FindText = "{{ProjectName}}",
                ReplaceText = project.InvName
            });
            replateTexts.Add(new ReplaceTextDto
            {
                FindText = "{{ProjectAddress}}",
                ReplaceText = project.LocationDescription
            });
        }

        private void TongThau(List<ReplaceTextDto> replateTexts, BusinessCustomer businessCustomer)
        {
            replateTexts.Add(new ReplaceTextDto
            {
                FindText = "{{GeneralContractorName}}",
                ReplaceText = businessCustomer.Name
            });
            replateTexts.Add(new ReplaceTextDto
            {
                FindText = "{{GeneralContractorShortName}}",
                ReplaceText = businessCustomer.ShortName
            });
        }

        private void ChuDauTu(List<ReplaceTextDto> replateTexts, BusinessCustomer businessCustomer)
        {
            replateTexts.Add(new ReplaceTextDto
            {
                FindText = "{{OwnerName}}",
        ...
        /// <param name="replateTexts"></param>
        /// <exception cref="FaultException"></exception>
        private void DongTien(List<ReplaceTextDto> replateTexts, CashFlowDto cashFlow)
        {
            replateTexts.Add(new ReplaceTextDto
            {
                FindText = "{{Interest}}",
            ...
            {
                FindText = "{{DayEndDate}}",
                ReplaceText = cashFlow.EndDate?.ToString("dd")
            });
            replateTexts.Add(new ReplaceTextDto
            {
                FindText = "{{MonthEndDate}}",
                ReplaceText = cashFlow.EndDate?.ToString("MM")
            });
            replateTexts.Add(new ReplaceTextDto
            {
                FindText = "{{YearEndDate}}",
                ReplaceText = cashFlow.EndDate?.ToString("yyyy")
            });
            replateTexts.Add(new ReplaceTextDto
            {
