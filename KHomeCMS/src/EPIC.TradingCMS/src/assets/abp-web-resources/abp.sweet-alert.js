...
(function () {
  ...
  abp.message.confirm = function (message, titleOrCallback, callback, isHtml, options) {
    ...
    options = options || {};
    options.title = title ? title : 'Bạn có chắc chắn?';
    options.icon = "warning";
    options.confirmButtonText = options.confirmButtonText || 'Đồng ý';
    options.cancelButtonText = options.cancelButtonText || 'Huỷ';
  ...
  var Toast = Swal.mixin({
    toast: true,
    position: "top",  // top-start | top | top-end
