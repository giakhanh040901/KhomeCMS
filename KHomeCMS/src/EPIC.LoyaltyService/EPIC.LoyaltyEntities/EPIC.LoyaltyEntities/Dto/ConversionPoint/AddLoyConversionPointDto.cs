...
{
    public class AddLoyConversionPointDto
    {
        /// <summary>
        /// Nhà đầu tư
        /// </summary>
        ...
        /// <summary>
        /// Có trừ điểm không khi chọn AllocationType = 2. Mặc định là có
        /// <see cref="YesNo"/>
        /// </summary>
        ...
        /// Chi tiết yêu cầu
        /// </summary>
        public List<AddLoyConversionPointDetailDto> Details { get; set; }
    }
}
