...
@Injectable()
export class ProjectPolicyService extends ServiceProxyBase { 
    private endPoint = `/api/real-estate/project-policy`;
    constructor(
    ...
    findAll(page: Page, id: number, filter?: any): Observable<any> {
        ...
        if (filter.policyType) url_ += this.convertParamUrl('policyType', filter.policyType);
