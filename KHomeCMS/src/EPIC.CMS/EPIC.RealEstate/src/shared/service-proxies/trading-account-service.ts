...
@Injectable()
export class TradingAccountService extends ServiceProxyBase {
    constructor(
    ...
    create(body): Observable<any> {
        let url_ = "/api/users/trading-provider/create";
        return this.requestPost(body,url_);
    }

    update(body): Observable<any> {
        let url_ = "/api/users/trading-provider/update";
        return this.requestPut(body,url_);
    }

    getAll(page: Page, tradingProviderId): Observable<any> {
