...
export class ContractFormService extends ServiceProxyBase {
    ...
    create(body): Observable<any>{
        return this.requestPost(body, "/api/garner/config-contract-code/add");
    }

    getAll(page: Page, fieldFilters): Observable<any> {
        let url_ = "/api/garner/config-contract-code/get-all?";
    ...
    getAllNoPermisson(page: Page): Observable<any> {
        let url_ = "/api/garner/config-contract-code/get-all-status-active?";
        url_ += this.convertParamUrl("keyword", page.keyword);
        url_ += this.convertParamUrl('pageSize', page.pageSize);
        url_ += this.convertParamUrl('pageNumber', page.getPageNumber());
        return this.requestGet(url_);
    ...
    update(body): Observable<any>{
        return this.requestPut(body, "/api/garner/config-contract-code/update");
    }
    ...
    delete(id: any): Observable<void> {
        let url_ = `/api/garner/config-contract-code/delete/` + id;
