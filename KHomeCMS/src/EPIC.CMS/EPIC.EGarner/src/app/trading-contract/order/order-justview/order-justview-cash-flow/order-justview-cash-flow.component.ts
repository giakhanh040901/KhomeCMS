...
@Component({
selector: 'app-order-justview-cash-flow',
templateUrl: './order-justview-cash-flow.component.html',
styleUrls: ['./order-justview-cash-flow.component.scss']
})
export class OrderJustviewCashFlowComponent extends CrudComponentBase {
