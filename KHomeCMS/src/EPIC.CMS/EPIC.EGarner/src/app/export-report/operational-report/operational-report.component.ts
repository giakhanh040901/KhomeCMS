...
export class OperationalReportComponent extends AppComponentBase {
  ...
  ngOnInit(): void {
    ...
    this._userService.getAllPermission().subscribe(res => {
      ...
      this.addReport(this.PermissionGarnerConst.Garner_BaoCao_VanHanh_TCTDauTu,
          "BÁO CÁO TỔNG CHI TRẢ ĐẦU TƯ",
          this.ExportReportConst.BC_TCT_DAU_TU);
      this.addReport(this.PermissionGarnerConst.Garner_BaoCao_VanHanh_THCKDauTu,
              "BÁO CÁO TỔNG HỢP CÁC KHOẢN ĐẦU TƯ",
              this.ExportReportConst.BC_TH_KHOAN_DAU_TU);
      this.addReport(this.PermissionGarnerConst.Garner_BaoCao_VanHanh_THSanPhamTichLuy,
              "BÁO CÁO TỔNG HỢP CÁC SẢN PHẨM TÍCH LŨY",
              this.ExportReportConst.BC_SP_TICH_LUY);
      this.addReport(this.PermissionGarnerConst.Garner_BaoCao_VanHanh_QuanTriTH, 
              "BÁO CÁO QUẢN TRỊ TỔNG HỢP",
              this.ExportReportConst.BC_QUAN_TRI_TH);
      this.addReport(this.PermissionGarnerConst.Garner_BaoCao_VanHanh_DauTuBanHo, 
