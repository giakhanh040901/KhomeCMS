...
export class ManagementReportComponent extends AppComponentBase {
  ...
  ngOnInit(): void {
    ...
    this._userService.getAllPermission().subscribe(res => {
      ...
      this.addReport(this.PermissionInvestConst.Invest_BaoCao_QuanTri_THCKDauTu,
              "BÁO CÁO TỔNG HỢP CÁC KHOẢN ĐẦU TƯ",
              this.ExportReportConst.BC_THCK_DAU_TU);
      this.addReport(this.PermissionInvestConst.Invest_BaoCao_QuanTri_THCMaBDS,
              "BÁO CÁO TỔNG HỢP CÁC MÃ BĐS",
              this.ExportReportConst.BC_THCK_CAC_BDS);
      this.addReport(this.PermissionInvestConst.Invest_BaoCao_QuanTri_DCDenHan,
              "BÁO CÁO DỰ CHI ĐẾN HẠN",
              this.ExportReportConst.BC_DC_DEN_HAN);
      this.addReport(this.PermissionInvestConst.Invest_BaoCao_QuanTri_ThucChi, 
              "BÁO CÁO THỰC CHI",
              this.ExportReportConst.BC_THUC_CHI);
      this.addReport(this.PermissionInvestConst.Invest_BaoCao_QuanTri_TCTDauTu, 
              "BÁO CÁO TÍNH TỔNG CHI TRẢ ĐẦU TƯ",
              this.ExportReportConst.BC_TTCT_DAU_TU);
      this.addReport(this.PermissionInvestConst.Invest_BaoCao_QuanTri_THCKDTVanHanhHVF, 
              "BÁO CÁO TỔNG HỢP CÁC KHOẢN ĐẦU TƯ VH",
              this.ExportReportConst.BC_THCKDT_VAN_HANH_HVF);
      this.addReport(this.PermissionInvestConst.Invest_BaoCao_QuanTri_SKTKNhaDauTu, 
              "BÁO CÁO SAO KÊ TÀI KHOẢN NHÀ ĐẦU TƯ",
              this.ExportReportConst.BC_SKTK_NHA_DAU_TU);
      this.addReport(this.PermissionInvestConst.Invest_BaoCao_QuanTri_THCKDTBanHo, 
             "BÁO CÁO TỔNG HỢP CÁC KHOẢN ĐẦU TƯ BÁN HỘ",
              this.ExportReportConst.BC_THCKDT_BAN_HO);
  ...
  onAccept() {
    ...
    const exportFunctions = {
      [this.ExportReportConst.BC_THCK_CAC_BDS]: () => this._exportReportService.getExportInvest(this.dataApprove.startDate, this.dataApprove.endDate),
      ...
      [this.ExportReportConst.BC_THCKDT_VAN_HANH_HVF]: () => this._exportReportService.getInvestmentHVF(this.dataApprove.startDate, this.dataApprove.endDate),
      [this.ExportReportConst.BC_SKTK_NHA_DAU_TU]: () => this._exportReportService.getInvestmentAccountStatistical(this.dataApprove.startDate, this.dataApprove.endDate),
      [this.ExportReportConst.BC_THCKDT_BAN_HO]: () => this._exportReportService.getSalesInvestment(this.dataApprove.startDate, this.dataApprove.endDate),
