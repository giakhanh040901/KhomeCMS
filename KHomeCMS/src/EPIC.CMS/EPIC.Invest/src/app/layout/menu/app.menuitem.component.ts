...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    updateActiveStateFromRoute() {
        // console.log('routerLink', this.router.url, this.item.routerLink, this.item.items, this.item.preventExact, this.item);
        this.active = this.router.isActive(this.item.routerLink[0], !this.item.items && !this.item.preventExact); 
                    // || (this.router.url.includes(this.item.routerLink[0]) && !this.item.items && !this.item.preventExact);
    }
