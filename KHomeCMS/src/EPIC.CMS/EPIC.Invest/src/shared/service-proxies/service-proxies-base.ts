...
export class ServiceProxyBase {
	...
	protected requestPostFormDataAuth(formData: FormData, url: String): Observable<any> {
		let url_ = this.baseUrl + url;
		url_ = url_.replace(/[?&]$/, '');
	...
	protected requestPutFormDataAuth(formData: FormData, url: String): Observable<any> {
		let url_ = this.baseUrl + url;
		url_ = url_.replace(/[?&]$/, '');
