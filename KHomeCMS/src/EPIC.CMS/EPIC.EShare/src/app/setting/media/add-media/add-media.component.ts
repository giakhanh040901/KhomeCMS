  ...
  // }
   ngOnInit() {
    ...
    if (this.config.data.inputData) {
      ...
      console.log("this.inputData.mainImg1",this.inputData.mainImg);
      
      this.mainImg = this.inputData.mainImg; 
      console.log("this.inputData.mainImg2",this.inputData.mainImg);
      ...
      console.log("this.inputData.mainImg2",this.mainImg);
      this.postForm = this.fb.group({
  ...
  selectImg() {
    ...
    ref.onClose.subscribe(images => { 
      if(images && images.length > 0) {
        ...
        this.detectVideo();
        this.checkImg = this.mainImg;
        
      }
    });
    console.log("this.mainImg",this.checkImg);
