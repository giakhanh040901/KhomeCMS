...
export class CalendarPartnerComponent extends CrudComponentBase {
    ...
    save() {
        this.submitted = true;
        // Fomat date Input
        this.setTimeZoneList(this.fieldDates, this.calendar);
        console.log({ calendar: this.calendar });
        this._calendarService.updateCalendarPartner(this.calendar).subscribe((response) => {
            if (this.handleResponseInterceptor(response, 'Cập nhật thành công')) {
                ...
                this.resetTimeZoneList(this.fieldDates, this.calendar);
                this.submitted = false;
            }
        }, () => {
            this.submitted = false;
