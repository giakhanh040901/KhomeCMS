...
export class PermissionBondConst {
    ...
    public static readonly BondWeb: string = `${PermissionBondConst.BondModule}${PermissionBondConst.Web}`;
    //
...
export class ApproveConst {
    ...
    public static STATUS_PRO_BOND_PRIMARY = 7;
...
export class ExportReportConst {
    public static BC_THCG_TRAI_PHIEU = 1;
    public static BC_THCG_DAU_TU = 2;
    public static BC_TGL_DEN_HAN = 3;
