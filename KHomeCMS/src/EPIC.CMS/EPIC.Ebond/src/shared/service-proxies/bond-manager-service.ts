...
export class ProductBondInfoServiceProxy extends ServiceProxyBase {
    ...
    getAllBondInfo(page: Page, status: string, isCheck:string, issueDate:any, dueDate:any): Observable<any> {
        let url_ = "/api/bond/product-bond-info/find?";
    ...
    closeOrOpen(id: number): Observable<any> {
        return this.requestPut(null, "/api/bond/product-bond-info/close-open?id=" + id);
    }
...
export class ReceiveContractTemplateServiceProxy extends ServiceProxyBase {
    ...
    create(body): Observable<any> {
        return this.requestPost(body, "/api/bond/receive-contract-template/add");
    }
    ...
    downloadContractTemplatePdf(tradingProviderId: any, contractTemplateId: any): Observable<any> {
        let url_ = `/api/bond/export-contract/file-receive-template-pdf?`;
    ...
    update(body): Observable<any> {
        return this.requestPut(body, "/api/bond/receive-contract-template/update/");
    }
    ...
    getAll(page: Page, params: any): Observable<any> {
        let url_ = "/api/bond/receive-contract-template/find-by-secondary?";
        url_ += this.convertParamUrl("keyword", page.keyword);
        url_ += this.convertParamUrl("bondSecondaryId", params?.bondSecondaryId);
...
export class ContractTemplateServiceProxy extends ServiceProxyBase {
    ...
    downloadContractTemplateWord(tradingProviderId: any, contractTemplateId: any): Observable<any> {
        let url_ = `/api/bond/export-contract/file-template-word?`;
        if(tradingProviderId){
            url_ += this.convertParamUrl("tradingProviderId", tradingProviderId);
        }
        if(contractTemplateId){
    ...
    downloadContractTemplatePdf(tradingProviderId: any, contractTemplateId: any): Observable<any> {
        let url_ = `/api/bond/export-contract/file-template-pdf?`;
        if(tradingProviderId){
            url_ += this.convertParamUrl("tradingProviderId", tradingProviderId);
        }
        if(contractTemplateId){
...
export class ProductBondPolicyTemplateServiceProxy extends ServiceProxyBase {
    ...
    get(id: number): Observable<any> {
        let url_ = "/api/bond/policy-temp/find-by-id?id=" + id;
        return this.requestGet(url_);
    }

    getAll(page: PageBondPolicyTemplate, status:any): Observable<any> {
        let url_ = "/api/bond/policy-temp/find?";
        url_ += this.convertParamUrl("keyword", page.keyword);
        url_ += this.convertParamUrl("status", status ?? '');
        url_ += this.convertParamUrl("isNoPaging", false);
    ...
    addListPolicy(body, id: number): Observable<any> {
        return this.requestPost(body, "/api/bond/secondary/add-list-policy?policytempId=" + id);
    }

    getAllListPolicy(page: Page, status: string, isClose?: string): Observable<any> {
        let url_ = `/api/bond/secondary/find?`;
        url_ += this.convertParamUrl("keyword", page.keyword);
        url_ += this.convertParamUrl("pageSize", page.pageSize);
        url_ += this.convertParamUrl("isNoPaging", true);
        url_ += this.convertParamUrl("pageNumber", page.getPageNumber());
