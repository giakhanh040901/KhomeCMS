...
import { ProductBondPrimaryConst, ProductBondInfoConst, ProductBondDetailConst, DistributionContractConst } from '@shared/AppConsts';
...
export class DistributionContractDetailComponent extends CrudComponentBase {
  ...
  constructor(
    ...
    this.breadcrumbService.setItems([
      ...
      { label: 'Hợp đồng phân phối', routerLink: ['/bond-manager/distribution-contract']  },
