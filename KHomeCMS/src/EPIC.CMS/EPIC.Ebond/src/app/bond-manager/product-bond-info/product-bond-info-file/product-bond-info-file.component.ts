...
@Component({
    selector: 'app-product-bond-info-file',
    templateUrl: './product-bond-info-file.component.html',
    styleUrls: ['./product-bond-info-file.component.scss'],
    providers: [ConfirmationService, MessageService]
})
export class ProductBondInfoFileComponent extends CrudComponentBase {
    ...
    ngOnInit() {
        this.actions = [
            ...
            //     label: 'Phê duyệt',
            //     icon: 'pi pi-check',
            //     statusActive: [this.StatusBondInfoFileConst.RESPONSE_FALSE],
    ...
    resetContractTemplateObject() {
        this.contractFile = {
            ...
            name: null,
            url: null,
            productBondId: +this.productBondId,
        };
    }
    ...
    setPage(pageInfo?: any) {
        ...
        this._productBondInfoFile.getAll(this.page, this.productBondId).subscribe(
            (res) => {
    ...
    save() {
        ...
        if (this.contractFile.fieldId) {
            this._productBondInfoFile.update(this.contractFile).subscribe(
                (response) => {
            ...
            this._productBondInfoFile.create(this.contractFile).subscribe(
                (response) => {
    ...
    delete(file) {
        ...
        this.confirmationService.confirm({
            ...
            accept: () => {
                this._productBondInfoFile.delete(data.juridicalFileId).subscribe((response) => {
    ...
    approve() {
        this.confirmationService.confirm({
            ...
            accept: () => {
                this._productBondInfoFile.approve(this.contractFile.juridicalFileId).subscribe((response) => {
    ...
    cancel() {
        this.confirmationService.confirm({
            ...
            icon: 'pi pi-check-circle',
            accept: () => {
                this._productBondInfoFile.cancel(this.contractFile.juridicalFileId).subscribe((response) => {
