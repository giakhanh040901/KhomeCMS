...
@Component({
  selector: 'app-overview-invest',
  templateUrl: './overview-invest.component.html',
  styleUrls: ['./overview-invest.component.scss']
})
export class OverviewInvestComponent extends CrudComponentBase {
  ...
  constructor(
    ...
    UpdateCashFlowByDayInfo() {
        ...
        console.log('cashFlowByDay__', this.cashFlowByDay);
    ...
    setPage(){
        ...
        this._dashBoardService.getInfoDashboardInvest(this.dataFilter).subscribe((res) => {
            this.isLoading = false;
            if (this.handleResponseInterceptor(res, '')) {
