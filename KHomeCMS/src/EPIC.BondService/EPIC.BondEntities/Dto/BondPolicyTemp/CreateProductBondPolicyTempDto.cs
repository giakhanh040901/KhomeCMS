...
namespace EPIC.Entities.Dto.ProductBondPolicyTemp
{
    public class CreateProductBondPolicyTempDto
    {
		...
		public List<CreateProductBondPolicyDetailTempDto> ProductBondPolicyDetailTemp { get; set; }
	}

	public class CreateProductBondPolicyDetailTempDto
    {
	...
	public class ProductBondPolicyDetailTempDto : CreateProductBondPolicyDetailTempDto
    {
